...
Analýza je spouštěna paralelně, a to prostřednictvím metody \texttt{parallelStream}. Proces analýzy samotné data nijak nemění, proto není nutné řešit souběh. To ale neplatí pro přidávání výsledků; z těchto důvodů je zde využit blok \texttt{synchronized} společně s mapou zámků (pro každý list výsledků jeden zámek).

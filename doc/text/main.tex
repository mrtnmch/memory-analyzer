...
V Javě je několik různých implementací \zkratka{GC}. Ty se liší rychlostí a efektivitou běhu a každý se může specializovat na jinou činnost \cite{gc-details}.
...
\begin{description}
    ...
    \item[Minimální \textit{footprint}] (stopa, využití prostředků)
\end{description}

\subsection{G1 GC}
G1 znamená \textit{Garbage First}. 

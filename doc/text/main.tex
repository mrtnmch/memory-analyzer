...
Jako reálnou testovací aplikaci, která má otevřený zdrojový kód, jsem si vybral framework \textit{Spring Boot}, v němž jsem vytvořil základní aplikaci \textit{Hello World}. Testoval jsem tedy framework samotný a ne aplikaci v něm vytvořenou. Dump z ní vytvořený má 74 MB.

\begin{table}[]
    \begin{tabular}{lrrrr}
    \textbf{Namespace}           & \multicolumn{1}{l}{\textbf{Počet tříd}} & \multicolumn{1}{l}{\textbf{Počet instancí}} & \multicolumn{1}{l}{\textbf{Nalezené problémy}} & \multicolumn{1}{l}{\textbf{Trvání {[}s{]}}} \\

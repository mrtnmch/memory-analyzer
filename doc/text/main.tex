...
\begin{description}
    ...
    \item[Výhody] Komerční nástroj, velké možnosti, stejně jako Eclipse MAT obsahuje proovnání základních objektů.
    \item[Nevýhody] Není zdarma, není opensource.
\end{description}
...
\section{NetBeans HeapWalker}
Součást IDE NetBeans, která dokáže pracovat se soubory typu HPROF. Z dumpu umí extrahovat třídy, jejich instance, proměnné a reference. K této funkcionalitě poskytuje grafické rozhraní, které je součástí NetBeans Profileru.
...
Standardní formát jako HPROF nabízí celou řadu existujících nástrojů a knihoven, které byly popsány v rámci kapitoly \ref{existing-solutions}. 
